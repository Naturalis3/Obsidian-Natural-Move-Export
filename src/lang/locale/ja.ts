export default {
	...
	SETTING_LICENSE_KEY_DESC: "Pro機能をアンロックするにはライセンスキーを入力してください（例：カスタム Pandoc 引数）。",
	SETTING_LICENSE_VERIFY_BUTTON: "認証",
	SETTING_BUY_PRO_NAME: "Proバージョンを入手",
	SETTING_BUY_PRO_DESC: "フォルダのコピー、Pandoc テンプレート、カスタム引数をアンロックします。",
	SETTING_BUY_PRO_BUTTON: "ライセンスを購入",
	LICENSE_VALID: "ライセンスは有効です！Pro機能がアンロックされました。",
	LICENSE_INVALID: "無効なライセンスキーです。",
	PRO_FEATURE_LOCKED: "これは Pro 機能です。有効なライセンスキーを入力してください。",
